...
function roots_scripts() {
  ...
  //wp_register_script('underscore_js', get_template_directory_uri() . '/assets/js/vendor/underscore-min.js', false, null, false);
  wp_register_script('require_js', get_template_directory_uri() . '/assets/js/require-min.js', false, null, false);
  wp_register_script('app_js', get_template_directory_uri() . '/assets/js/app.js', false, null, false);
  //wp_register_script('backbone_js', get_template_directory_uri() . '/assets/js/vendor/backbone-min.js', false, null, false);
